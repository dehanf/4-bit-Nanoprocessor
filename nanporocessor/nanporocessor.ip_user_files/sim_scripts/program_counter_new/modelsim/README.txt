...
#
# Generated by export_simulation on Sat May 24 21:24:08 +0530 2025
#
################################################################################
...
'-reset_run' switch to the './program_counter_new.sh' script.

./program_counter_new.sh -reset_run
...
./program_counter_new.sh -noclean_files

For more information on the script, please type './program_counter_new.sh -help'.
