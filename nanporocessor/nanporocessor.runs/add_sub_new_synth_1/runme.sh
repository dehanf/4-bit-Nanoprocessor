...
HD_PWD='D:/nano enhanced/nanporocessor/nanporocessor.runs/add_sub_new_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log add_sub_new.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source add_sub_new.tcl
