...
HD_PWD='D:/nano enhanced/nanporocessor/nanporocessor.runs/program_counter_new_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log program_counter_new.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source program_counter_new.tcl
